...
export default function LandingPage() {
  return (
    <div className="bg-hero-pattern bg-cover w-full h-full bg-no-repeat bg-top ">
      <div className="px-5 items-center pt-32">
        <div className="pt-0 lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2 text-center font-extrabold text-dark-text">
